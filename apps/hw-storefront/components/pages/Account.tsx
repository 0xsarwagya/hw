...
import type { OrderItem as BackendOrderItem } from "../../lib/validations/order";
...
const Account: React.FC = () => {
  ...
  const handleAddAddress = () => {
    ...
    const newAddress: Address = {
      ...
      type: "both", // Use "both" instead of "Other"
                    ...
                    {expandedOrder === order.id && (
                      <div className="p-4 md:p-6 animate-[slide-down_0.3s_ease-out]">
                        <div className="space-y-4">
                          {order.items.map(
                            (item: BackendOrderItem, idx: number) => (
                              <div
                                key={idx}
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-100 flex justify-between items-start">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              Shipping Address ID: {order.shippingAddressId}
                            </p>
                          </div>
