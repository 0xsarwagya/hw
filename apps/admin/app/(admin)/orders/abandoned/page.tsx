...
import { AbandonedCheckoutsTable } from "@/components/abandoned-checkouts/abandoned-checkouts-table";
...
export default function AbandonedCheckoutsPage() {
  ...
  const [filters, setFilters] = useState({
    ...
    recoverable: searchParams.get("recoverable") === "true" ? true : undefined,
    ...
    <AdminPageLayout
      ...
      filters={
        <div className="flex flex-wrap items-center gap-4">
          <Select
            value={filters.recoverable === undefined ? "all" : filters.recoverable ? "true" : "false"}
            onValueChange={(value) =>
              setFilters((prev) => ({
                ...prev,
          ...
          <Select
            value={filters.hasEmail === undefined ? "all" : filters.hasEmail ? "true" : "false"}
            onValueChange={(value) =>
              setFilters((prev) => ({
                ...prev,
