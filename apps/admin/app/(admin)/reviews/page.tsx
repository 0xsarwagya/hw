...
export default function ReviewsPage() {
  ...
  const { data, isLoading, error, refetch } = useAdminPendingReviews(page, limit);
                  ...
                  <TableCell>
                    <div className="flex gap-2">
                      <Button
                        ...
                        disabled={processingReviewId !== null || deleteReview.isPending}
                        title="Approve review"
                      >
                        {processingReviewId === review.id && approveReview.isPending ? (
                      ...
                      <Button
                        ...
                        title="Reject review"
                      >
                        {processingReviewId === review.id && rejectReview.isPending ? (
                          <div className="h-4 w-4 animate-spin rounded-full border-2 border-current border-t-transparent" />
                        ) : (
                          <X className="h-4 w-4" />
                        )}
                      ...
                      <Button
                        ...
                        title="Delete review"
                      >
                        {deleteReview.isPending && reviewToDelete === review.id ? (
                          <div className="h-4 w-4 animate-spin rounded-full border-2 border-current border-t-transparent" />
                        ) : (
