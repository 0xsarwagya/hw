...
export const WIZARD_STEPS: readonly WizardStep[] = [
  { id: 1, title: "Basic Information", description: "Product details and description" },
  { id: 2, title: "Pricing & Tax", description: "Set price and tax information" },
...
export const WIZARD_MESSAGES = {
  ...
  DEFAULT_VARIANT_ERROR: "Failed to create default variant. You can create it manually.",
  VARIANTS_CREATE_SUCCESS: (count: number) => `${count} variant(s) created successfully`,
  VARIANTS_CREATE_ERROR: "Some variants failed to create. You can add them manually.",
  ...
  PRODUCT_VARIANTS_COMPLETE_SUCCESS: "Product and variants created successfully",
  VARIANTS_COMPLETE_ERROR: "Failed to create variants",
  VALIDATION_OPTION_TYPES_REQUIRED: "Please add at least one variant option type",
  VALIDATION_OPTION_VALUES_REQUIRED: "All option types must have at least one value",
  ...
  VALIDATION_VARIANTS_BEFORE_COMPLETE: "Please create at least one variant before completing",
} as const;
